<template>
  <div>
    <form @submit.prevent="createEvent">
      ...
      <base-input label="Title" v-model="event.title" type="text" placeholder="Add an event title"/>
      <base-input
        label="Description"
      ...
      <BaseButton type="submit" buttonClass="-fill-gradient">Submit in base</BaseButton>
    </form>
  </div>
</template>
<script>
